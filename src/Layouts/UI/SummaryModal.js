import { Overlay, ModalStyled, CloseButton, AnimatedCar } from "../../Assets/Styles/UI/SummaryModal.styles";
...
const SummaryModal = ({ isOpen, onClose, children }) => {
  ...
  useEffect(() => {
    ...
    if (isOpen && carElement) {
        ...
        return () => carElement.removeEventListener('animationend', handleAnimationEnd);
    }
}, [isOpen, onClose]);
