...
import {
	...
	CancelButton,
	ConfirmButton,
} from "../../assets/Styles/AdministrationPanel/Popups/Popups.styles"
	...
	return (
		<PopupOverlay>
			<PopupDeleteWrapper>
				...
				<div>
					<p>
						<strong>Czy chcesz usunąć wybrany element?</strong>
					</p>
				...
				<div>
					...
					<ConfirmButton
						onClick={() => {
							deleteObject(
								props.delObjectInfo.endpoint,
								props.delObjectInfo.objectID
							)
							closePopup()
						}}>
						Ok
