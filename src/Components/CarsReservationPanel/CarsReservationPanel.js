...
import {
	...
	FilterSection,
	ContentSection,
	ReservationSearchShadow,
	PhoneNumberReservation,
	ErrorMessage,
} from "../../assets/Styles/CarsReservationPanel/CarsReservationPanel.styles"
	...
	return (
		<Container direction={direction}>
			<FilterSection width={width}>
				...
				<ReservationFilter
					carTypeFilter={filters.type}
					onCarTypeChange={handleCarTypeChange}
				/>
			</FilterSection>
			<ContentSection width={showPlates ? "70%" : "100%"}>
				{showPlates && (
					<Plates carTypeFilter={highlighted} onSelect={handleCarTypeChange} />
				)}
				<TrolleyIconWrapper>
					<TrolleyIconContainer onClick={handleIconClick}>
						<TrolleyIcon />
						<TrolleyIconText>
							{t("yourBasket", { count: reservedCars.length })}
						</TrolleyIconText>
					</TrolleyIconContainer>
				</TrolleyIconWrapper>
