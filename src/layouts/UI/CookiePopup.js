...
import {
	...
	Slider,
	ConfirmButton,
} from "../../assets/Styles/UI/CookiePopup.styles"
			...
			<Overlay>
				<PopupContainer>
					...
					{[
						{
							key: "trafficAnalysis",
							label: t("trafficAnalysis.title"),
							description: t("trafficAnalysis.description"),
						},
						{
							key: "adsAndProfiling",
							label: t("adsAndProfiling.title"),
							description: t("adsAndProfiling.description"),
						},
						{
							key: "optimization",
						...
						<PreferenceContainer key={key}>
							...
							<ToggleButton
								isActive={preferences[key]}
								onClick={() => handleTogglePreference(key)}>
								<ToggleText text='OFF' isActive={!preferences[key]}>
									OFF
								</ToggleText>
								<ToggleText text='ON' isActive={preferences[key]}>
									ON
								</ToggleText>
								<Slider />
							</ToggleButton>
