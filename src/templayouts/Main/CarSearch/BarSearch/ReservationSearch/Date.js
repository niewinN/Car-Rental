...
const Date = ({ useDate, onClick, selectedDate, onDateChange }) => {
			...
			return (
				<div className='date' onClick={() => onClick(useDate)}>
					<div className='pick-up'>
						...
						<p>
							{selectedPickupState
								? selectedPickupState.format("DD-MM-YYYY")
								: "-- -- ----"}
						</p>
					</div>
					...
					<p>
						{selectedPickupState
							? selectedPickupState.format("HH:mm")
							: "--:--"}
					</p>
				</div>
			)
			...
			return (
				<div className='date' onClick={() => onClick(useDate)}>
					<div className='pick-up'>
						...
						<p>
							{selectedReturnState
								? selectedReturnState.format("DD-MM-YYYY")
								: "-- -- ----"}
						</p>
					</div>
					<div className='line'></div>
					<p>
						{selectedReturnState
							? selectedReturnState.format("HH:mm")
							: "--:--"}
					</p>
				</div>
			)
	...
	return <StyledDate onClick={handleDateClick}>{content()}</StyledDate>
}
